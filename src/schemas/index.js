...
export const devisCreateSchema = z.object({
  ...
  ville_dep: z.string().optional().default(""),
  ville_arr: z.string().optional().default(""),
  horaire_dep: z.string().optional().default(""),
  horaire_arr: z.string().optional().default(""),
  horaire_dep_retour: z.string().optional().default(""),
  horaire_arr_retour: z.string().optional().default(""),
